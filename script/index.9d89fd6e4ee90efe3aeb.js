...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/Mona-Kastenedd0aa4e03dd4c9a1547e094cc3ca9b2.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/angle-left-solide6b3ab3d849e255239050c015e981bd3.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/angle-right-solidcd2a56f425767e222ad419397c94fe29.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/author-bio-bg-mobile90d5808103d583f85f4dd1059865cf97.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/author-bio-bg97e25dc93dfa94ff37ee36508ceec8dc.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/bg-17aff0e024a11897ce912dbd3724019a6.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/bookzone-logo0df8739be276241b3ce2a0ccc7dd29c9.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/carte-outro-big91dbf37e670ba982ab7dd36dbb9be0e7.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/couple-bgc27b1cdaeae5a568a437327f5e49a09d.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/fragment-bg-mobile6e5d0e306bd60de882c8fd22f6c1bb7d.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/fragment-bg0b2225e9fd5b7d2b4d506f658403f4bd.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/medalief42ae91ae1d3e356388edd1a253afcdf.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/preview-carte41755f2900c03ee8291dca2b3b451dd2.png");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "media/quote-img5654419e43857a8bdecbf72650a8161b.png");
...
var map = {
	"./Mona-Kasten.png": 2829,
	"./angle-left-solid.svg": 47,
	"./angle-right-solid.svg": 3031,
	"./author-bio-bg-mobile.png": 7297,
	"./author-bio-bg.png": 387,
	"./bg-1.png": 8583,
	"./bookzone-logo.png": 2512,
	"./carte-outro-big.png": 2950,
	"./couple-bg.png": 3986,
	"./fragment-bg-mobile.png": 729,
	"./fragment-bg.png": 8579,
	"./medalie.png": 6311,
	"./preview-carte.png": 5022,
	"./quote-img.png": 5741
};
...
// EXTERNAL MODULE: ./src/media/quote-img.png
var quote_img = __webpack_require__(5741);
;// CONCATENATED MODULE: ./src/script/slider.js
 // Revealing Module Pattern - long story short: only make public the data / functionality that is needed
// Using an IIFE - runs as soon as it's defined
// I could use a class as well and use public / private keywords for same purpose
...
const slider = function () {
  ...
  const sliderRoot = document.getElementById('slider-root'),
        ...
        // https://bookzone.ro/produs/un-nou-inceput-seria-again-mona-kasten#reviews
  reviews = [{
    review: '5 stele! A fost o carte atât de bună, încât mi-aș fi dorit să nu se termine. Cartea aceasta reprezintă motivul pentru care îmi place să citesc. Momente de furie, de îngrijorare, de romantism. Cartea aceasta are tot ce ți-ai putea dori. Kaden are toate trăsăturile pe care le iubesc la un erou demn de ura cititorilor. Allie este înfocată și puternică, nu îi acceptă prostiile lui Kaden, toate aceste lucruri condimentând acțiunea cu momente amuzante.',
    owner: '- Tessa'
  }, {
    review: 'Un romance foarte bun, care desi pare un cliseu de fata buna- baiat rau, insa aceasta carte rupe tiparul de baiat rau. Allie este o fata care doreste sa fie independenta si alege sa plece la facultate in alt oras. Asa il intalneste pe Kaden care detine apartamentul in care va locui. Insa Kaden este sceptic cu privire la locuitul cu o fata si impune niste reguli. Dar regulile sunt facute pentru a fi incalcate, nu?',
    owner: '- Zenaida'
  }, {
    review: 'Tare drăguță! Ușor de citit (evident), amuzantă, are o grămadă de scene pe care femeile le adoră pentru că le fac să simtă fluturași. Nu mi-a plăcut cum a reacționat el în timpul unei discuții, dar fie! Scârba asta de dragoste e complicată uneori.',
    owner: '- Sandra Deaconu'
  }];

  function setData(index) {
    const data = reviews[index]; // We always need to make sure that the DOM element exists

    if (sliderRoot) {
      let html = '';
      reviews.forEach(data => {
        html += `
          <div class='position-absolute animate-slider full-w full-h'>
            <img class='position-absolute' src='${quote_img.default}' alt='quote' />
            <p class="position-relative mb-2">
            ${data.review}
            </p>

            <p class="position-relative text-align-right"> ${data.owner}</p>
          </div>
        `;
      });
      sliderRoot.innerHTML = html;
    }
  }

  function animateSlides(currentIndex) {
    const animatedSliders = document.querySelectorAll('.animate-slider'); // We always need to make sure that the DOM element exists

    if (sliderRoot && animatedSliders.length) {
      const marginX = 150;
      const sliderTotalWidth = sliderRoot.getBoundingClientRect().width + marginX * 2;
      animatedSliders.forEach((element, index) => {
        const pos = sliderTotalWidth * (index - currentIndex);
  ...
  const changeSlide = event => {
    ...
    animateSlides(currentIndex); // Prevent event bubbling
  ...
  }; // We always need to make sure that the DOM element exists


  if (prevBtn) {
    prevBtn.addEventListener('click', throttle(changeSlide, 700));
  } // We always need to make sure that the DOM element exists


  if (nextBtn) {
    nextBtn.addEventListener('click', throttle(changeSlide, 700));
  }

  setData(currentIndex);
  animateSlides(currentIndex);
  return {
    animateSlides: () => animateSlides(currentIndex)
  };
}();

/* harmony default export */ const script_slider = (slider);
;// CONCATENATED MODULE: ./src/script/utils.js
const utils = function () {
  const getImage = src => __webpack_require__(9491)(`./${src}`).default;
...
/* harmony default export */ const script_utils = (utils);
;// CONCATENATED MODULE: ./src/script/mobile.js

 // Change image based on breakpoint
// Yes you are right, i could just do 2 img elements and set display block / none
// But i choose to use ResizeObserver api because it gives me more flexibility in terms of "javascript styling"

const mobile = function () {
  const authorBgImage = document.querySelector('#reviews .author-bio img.bg');
  const {
    getImage
  } = script_utils;
  const resizeObserver = new ResizeObserver(entries => {
    ...
    if (authorBgImage) {
      const img = getImage(`${isMobile ? 'author-bio-bg-mobile' : 'author-bio-bg'}.png`);
      authorBgImage.setAttribute('src', img);
    } // When changing from landscape to portrait or vice-versa, reset the slider divs transform property


    script_slider.animateSlides();
  });
  resizeObserver.observe(document.body);
  return {};
}();

/* harmony default export */ const script_mobile = ((/* unused pure expression or super */ null && (mobile)));
...
/******/ })()
;
//# sourceMappingURL=index.9d89fd6e4ee90efe3aeb.js.map